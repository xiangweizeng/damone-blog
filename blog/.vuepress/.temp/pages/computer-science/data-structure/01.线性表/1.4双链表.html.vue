<template><div><h3 id="_1-4-1-单链表的定义" tabindex="-1"><a class="header-anchor" href="#_1-4-1-单链表的定义" aria-hidden="true">#</a> 1.4.1 单链表的定义</h3>
<p>单链表的结点中只有一个指向其后继的指针，使得单链表要访问某个结点的前驱结点时，只能从头开始遍历，访问后驱结点的复杂度为O(1)，访问前驱结点的复杂度为O(n)。为了克服上述缺点，引入了双链表。</p>
<p><code v-pre>双链表</code>的结点中有两个指针<code v-pre>prior</code>和<code v-pre>next</code>，分别指向前驱结点和后继结点。</p>
<h3 id="_1-4-2-双链表的实现方式" tabindex="-1"><a class="header-anchor" href="#_1-4-2-双链表的实现方式" aria-hidden="true">#</a> 1.4.2 双链表的实现方式</h3>
...
<h3 id="_1-4-3-双链表上的操作-带头结点" tabindex="-1"><a class="header-anchor" href="#_1-4-3-双链表上的操作-带头结点" aria-hidden="true">#</a> 1.4.3 双链表上的操作（带头结点）</h3>
<h4 id="双链表的类型描述" tabindex="-1"><a class="header-anchor" href="#双链表的类型描述" aria-hidden="true">#</a> 双链表的类型描述</h4>
<div class="language-C line-numbers-mode" data-ext="C"><pre v-pre class="language-C"><code>typedef struct DNode{
    int data;  //数据域
    struct DNode *prior,*next;  //前驱和后继指针
}DNode, *DLinkList;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="初始化" tabindex="-1"><a class="header-anchor" href="#初始化" aria-hidden="true">#</a> 初始化</h4>
<figure><img src="/images/datastruct/20210418102417468.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
bool <span class="token function">Empty</span><span class="token punctuation">(</span>DLinkList L<span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="建立双链表" tabindex="-1"><a class="header-anchor" href="#建立双链表" aria-hidden="true">#</a> 建立双链表</h4>
<h5 id="头插法建立双链表" tabindex="-1"><a class="header-anchor" href="#头插法建立双链表" aria-hidden="true">#</a> 头插法建立双链表</h5>
<p>用于链表的逆置</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//头插法建立双链表</span>
...
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//尾插法建立双链表</span>
...
<figure><img src="/images/datastruct/20210418105409128.jpg" alt="插入操作" tabindex="0" loading="lazy"><figcaption>插入操作</figcaption></figure>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//将x插入到双链表L中*p结点的下一个结点</span>
...
<figure><img src="/images/datastruct/20210418104109509.png" alt="删除操作" tabindex="0" loading="lazy"><figcaption>删除操作</figcaption></figure>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//删除操作:将双链表中的第i个结点删除</span>
bool <span class="token function">Delete</span><span class="token punctuation">(</span>DLinkList <span class="token operator">&amp;</span>L<span class="token punctuation">,</span> <span class="token keyword">int</span> i<span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token keyword">return</span> true<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="指定结点的删除" tabindex="-1"><a class="header-anchor" href="#指定结点的删除" aria-hidden="true">#</a> 指定结点的删除</h5>
<p><code v-pre>时间复杂度</code>=O(1)</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//删除操作:删除双链表中的p结点的后继结点</span>
<span class="token keyword">void</span> <span class="token function">DeleteNextNode</span><span class="token punctuation">(</span>DNode <span class="token operator">*</span>p<span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token function">free</span><span class="token punctuation">(</span>q<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="查找-与单链表完全一样" tabindex="-1"><a class="header-anchor" href="#查找-与单链表完全一样" aria-hidden="true">#</a> 查找(与单链表完全一样)</h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="遍历-与单链表完全一样" tabindex="-1"><a class="header-anchor" href="#遍历-与单链表完全一样" aria-hidden="true">#</a> 遍历(与单链表完全一样)</h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-4-4-完整代码" tabindex="-1"><a class="header-anchor" href="#_1-4-4-完整代码" aria-hidden="true">#</a> 1.4.4 完整代码</h3>
...
<figure><img src="/images/datastruct/20210418142232335.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</div></template>
