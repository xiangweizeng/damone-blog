<template><div><h3 id="_1-5-1-循环链表的定义" tabindex="-1"><a class="header-anchor" href="#_1-5-1-循环链表的定义" aria-hidden="true">#</a> 1.5.1 循环链表的定义</h3>
<p><code v-pre>循环链表</code>：一般包括循环循环链表和循环循环链表，如下图所示</p>
<figure><img src="/images/datastruct/2021041814455792.jpg" alt="循环链表" tabindex="0" loading="lazy"><figcaption>循环链表</figcaption></figure>
<h3 id="_1-5-2-循环链表的实现方式" tabindex="-1"><a class="header-anchor" href="#_1-5-2-循环链表的实现方式" aria-hidden="true">#</a> 1.5.2 循环链表的实现方式</h3>
...
<h3 id="_1-5-3-循环单链表上的操作-带头结点" tabindex="-1"><a class="header-anchor" href="#_1-5-3-循环单链表上的操作-带头结点" aria-hidden="true">#</a> 1.5.3 循环单链表上的操作（带头结点）</h3>
<h4 id="循环单链表的类型描述-与单链表一样" tabindex="-1"><a class="header-anchor" href="#循环单链表的类型描述-与单链表一样" aria-hidden="true">#</a> 循环单链表的类型描述(与单链表一样)</h4>
<div class="language-C line-numbers-mode" data-ext="C"><pre v-pre class="language-C"><code>typedef struct LNode{    //定义循环链表结点类型
	int data;            //数据域，可以是别的各种数据类型，本文统一用int类型
	struct LNode *next;  //指针域
}LNode, *LinkList;;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="初始化和判空-与单链表不一样" tabindex="-1"><a class="header-anchor" href="#初始化和判空-与单链表不一样" aria-hidden="true">#</a> 初始化和判空(与单链表不一样)</h4>
<p>L-&gt;next = NULL改为L-&gt;next = L</p>
...
bool <span class="token function">Empty</span><span class="token punctuation">(</span>LinkList L<span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="判断表尾结点" tabindex="-1"><a class="header-anchor" href="#判断表尾结点" aria-hidden="true">#</a> 判断表尾结点</h4>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//判断结点p是否是表尾结点</span>
bool <span class="token function">isTail</span><span class="token punctuation">(</span>LinkList L<span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="插入、删除" tabindex="-1"><a class="header-anchor" href="#插入、删除" aria-hidden="true">#</a> 插入、删除</h4>
<p>循环单链表的插入、删除算法与单链表几乎一样，不同的是如果在表尾进行，那么要让单链表继续<strong>保持循环的性质</strong>，即<strong>让尾结点的next域指向头结点</strong>。</p>
<p><code v-pre>时间复杂度</code>=O(1)</p>
<h4 id="查找" tabindex="-1"><a class="header-anchor" href="#查找" aria-hidden="true">#</a> 查找</h4>
<p>单链表的查找是从表头开始，找到表尾停止。而循环单链表中，若从表头开始查找，那与单链表的操作一致。若从表的任意位置开始查找，那么需要一个计数变量sum，当sum=表长时还未找到，则查找失败，退出循环。</p>
<h4 id="求表长" tabindex="-1"><a class="header-anchor" href="#求表长" aria-hidden="true">#</a> 求表长</h4>
<p>与单链表一样</p>
<h4 id="遍历" tabindex="-1"><a class="header-anchor" href="#遍历" aria-hidden="true">#</a> 遍历</h4>
<p>单链表只能从表头结点开始往后顺序遍历整个链表，循环单链表可以从表中的<code v-pre>任意一个结点开始</code>遍历整个链表。</p>
<h3 id="_1-5-4-循环双链表上的操作-带头结点" tabindex="-1"><a class="header-anchor" href="#_1-5-4-循环双链表上的操作-带头结点" aria-hidden="true">#</a> 1.5.4 循环双链表上的操作（带头结点）</h3>
<h4 id="循环链表的类型描述" tabindex="-1"><a class="header-anchor" href="#循环链表的类型描述" aria-hidden="true">#</a> 循环链表的类型描述</h4>
...
bool <span class="token function">Empty</span><span class="token punctuation">(</span>DLinkList L<span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="判断表尾结点-1" tabindex="-1"><a class="header-anchor" href="#判断表尾结点-1" aria-hidden="true">#</a> 判断表尾结点</h4>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//判断结点p是否是表尾结点</span>
...
<p>循环双链表的插入、删除算法与双链表几乎一样，不同的是如果在表尾进行，那么要让双链表继续<strong>保持循环的性质</strong>，即<strong>让尾结点的next域指向头结点，同时让头结点的prior域指向尾结点</strong>。</p>
<p><code v-pre>注</code>：p-&gt;next-&gt;prior = s; 循环时不判断</p>
<p><code v-pre>时间复杂度</code>=O(1)</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//将x插入到循环链表L中*p结点的下一个结点</span>
...
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//删除操作:将循环链表中的第i个结点删除</span>
...
<p><code v-pre>时间复杂度</code>=O(1)</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//删除操作:删除循环链表中的p结点的后继结点</span>
<span class="token keyword">void</span> <span class="token function">DeleteNextNode</span><span class="token punctuation">(</span>DNode <span class="token operator">*</span>p<span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token function">free</span><span class="token punctuation">(</span>q<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="查找-与单双链表完全一样" tabindex="-1"><a class="header-anchor" href="#查找-与单双链表完全一样" aria-hidden="true">#</a> 查找(与单双链表完全一样)</h4>
<h5 id="按位查找" tabindex="-1"><a class="header-anchor" href="#按位查找" aria-hidden="true">#</a> 按位查找</h5>
<p><code v-pre>平均时间复杂度</code>=O(n)</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//按位查找：查找在循环链表L中第i个位置的结点</span>
