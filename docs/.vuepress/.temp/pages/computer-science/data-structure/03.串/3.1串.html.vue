<template><div><h1 id="_3-1-串-即字符串" tabindex="-1"><a class="header-anchor" href="#_3-1-串-即字符串" aria-hidden="true">#</a> 3.1. 串，即字符串</h1>
<h2 id="_3-1-1-串的定义" tabindex="-1"><a class="header-anchor" href="#_3-1-1-串的定义" aria-hidden="true">#</a> 3.1.1 串的定义</h2>
<p><code v-pre>串</code>是一种特殊的<code v-pre>线性表</code>，串的<code v-pre>数据对象</code>限定为<code v-pre>字符集</code></p>
<h2 id="_3-1-2-串的基本操作" tabindex="-1"><a class="header-anchor" href="#_3-1-2-串的基本操作" aria-hidden="true">#</a> 3.1.2 串的基本操作</h2>
<p><code v-pre>注</code>：参数代“&amp;”表示：方法运行完后，对参数修改的结果要<code v-pre>“带回来”</code></p>
<p>对数据的操作：创销，增删查改</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token function">StrAssign</span><span class="token punctuation">(</span><span class="token operator">&amp;</span>τ chars<span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//赋值操作。把串T赋值为chars</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-1-3-存储结构" tabindex="-1"><a class="header-anchor" href="#_3-1-3-存储结构" aria-hidden="true">#</a> 3.1.3 存储结构</h2>
