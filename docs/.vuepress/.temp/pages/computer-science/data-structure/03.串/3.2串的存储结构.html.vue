<template><div><h1 id="_3-2-串的存储结构" tabindex="-1"><a class="header-anchor" href="#_3-2-串的存储结构" aria-hidden="true">#</a> 3.2 串的存储结构</h1>
<h2 id="_3-2-1-串的存储结构" tabindex="-1"><a class="header-anchor" href="#_3-2-1-串的存储结构" aria-hidden="true">#</a> 3.2.1 串的存储结构</h2>
<p><code v-pre>顺序存储</code>和<code v-pre>链式存储</code></p>
<h2 id="_3-2-2-串的顺序存储的实现方式" tabindex="-1"><a class="header-anchor" href="#_3-2-2-串的顺序存储的实现方式" aria-hidden="true">#</a> 3.2.2 串的顺序存储的实现方式</h2>
<p>实现方式：<code v-pre>静态分配</code>和<code v-pre>动态分配</code>，一般用动态分配</p>
<h3 id="串的类型描述" tabindex="-1"><a class="header-anchor" href="#串的类型描述" aria-hidden="true">#</a> 串的类型描述：</h3>
<h4 id="静态分配-sstring" tabindex="-1"><a class="header-anchor" href="#静态分配-sstring" aria-hidden="true">#</a> 静态分配：SString</h4>
<div class="language-C line-numbers-mode" data-ext="C"><pre v-pre class="language-C"><code>#define MAXLEN 255;			 //定义最大长度
typedef struct{
    char ch[MAXLEN];         //“静态”的数组存数据，存字符
    int length;              //串的实际长度
}SString;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="动态分配-hstring" tabindex="-1"><a class="header-anchor" href="#动态分配-hstring" aria-hidden="true">#</a> 动态分配：HString</h4>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">typedef</span> <span class="token keyword">struct</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="静态分配的顺序存储的串的优缺点" tabindex="-1"><a class="header-anchor" href="#静态分配的顺序存储的串的优缺点" aria-hidden="true">#</a> 静态分配的顺序存储的串的优缺点</h3>
<p><code v-pre>缺点</code>：串的顺序存储的表长确定后无法修改，存满了就存不了了</p>
<h3 id="动态分配的顺序表的优缺点" tabindex="-1"><a class="header-anchor" href="#动态分配的顺序表的优缺点" aria-hidden="true">#</a> 动态分配的顺序表的优缺点：</h3>
<p><code v-pre>优点</code>：可以动态增加长度</p>
<p><code v-pre>缺点</code>：动态增加长度中的迁移工作时间开销大</p>
<h2 id="_3-2-3-串的链式存储的实现方式" tabindex="-1"><a class="header-anchor" href="#_3-2-3-串的链式存储的实现方式" aria-hidden="true">#</a> 3.2.3 串的链式存储的实现方式</h2>
<p>实现方式：<code v-pre>不带头结点</code>和<code v-pre>带头结点</code>，一般用带头结点</p>
<p><code v-pre>不带头结点</code>和<code v-pre>带头结点</code>的类型描述相同，初始化和判空不同</p>
<h3 id="串的类型描述-1" tabindex="-1"><a class="header-anchor" href="#串的类型描述-1" aria-hidden="true">#</a> 串的类型描述：</h3>
<p>分为：<code v-pre>单个分配</code>和<code v-pre>堆分配</code>，一般用堆分配</p>
<p>单个分配存储密度低，堆分配存储密度高</p>
<h4 id="单个分配" tabindex="-1"><a class="header-anchor" href="#单个分配" aria-hidden="true">#</a> 单个分配：</h4>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">typedef</span> <span class="token keyword">struct</span> <span class="token class-name">StringNode</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="堆分配" tabindex="-1"><a class="header-anchor" href="#堆分配" aria-hidden="true">#</a> 堆分配：</h4>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">typedef</span> <span class="token keyword">struct</span> <span class="token class-name">StringNode</span><span class="token punctuation">{</span>
    ...
    <span class="token keyword">struct</span> <span class="token class-name">StringNode</span> <span class="token operator">*</span>next<span class="token punctuation">;</span>
<span class="token punctuation">}</span>StringNode<span class="token punctuation">,</span> <span class="token operator">*</span>String<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-2-4-串的上的操作" tabindex="-1"><a class="header-anchor" href="#_3-2-4-串的上的操作" aria-hidden="true">#</a> 3.2.4 串的上的操作</h2>
<p>以静态分配的顺序串为主</p>
<h3 id="求子串" tabindex="-1"><a class="header-anchor" href="#求子串" aria-hidden="true">#</a> 求子串</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//求子串</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="字符串比较" tabindex="-1"><a class="header-anchor" href="#字符串比较" aria-hidden="true">#</a> 字符串比较</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">//字符串比较操作。若S>T,则返回值>0;若S=T,则返回值=0;若S&lt;T,则返回值&lt;0。</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="定位操作" tabindex="-1"><a class="header-anchor" href="#定位操作" aria-hidden="true">#</a> 定位操作</h3>
