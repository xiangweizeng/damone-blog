<template><div><h1 id="_2-4-队列" tabindex="-1"><a class="header-anchor" href="#_2-4-队列" aria-hidden="true">#</a> 2.4 队列</h1>
<h2 id="_2-4-1-队列的定义" tabindex="-1"><a class="header-anchor" href="#_2-4-1-队列的定义" aria-hidden="true">#</a> 2.4.1 队列的定义</h2>
<p><code v-pre>队列</code>是只允许在一端进行插入，在另一端进行删除的线性表（<code v-pre>先进先出</code>，<code v-pre>后进后出</code>）</p>
<figure><img src="/images/datastruct/1-140G31P93Y96.jpg" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<h2 id="_2-4-2-队列的基本操作" tabindex="-1"><a class="header-anchor" href="#_2-4-2-队列的基本操作" aria-hidden="true">#</a> 2.4.2 队列的基本操作</h2>
<p><code v-pre>注</code>：参数代“&amp;”表示：方法运行完后，对参数修改的结果要<code v-pre>“带回来”</code></p>
<p>对数据的操作：创销，增删查改</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token function">InitQueue</span><span class="token punctuation">(</span><span class="token operator">&amp;</span>Q<span class="token punctuation">)</span><span class="token punctuation">;</span>     <span class="token comment">//初始化队列：构造一个空队列Q，分配内存空间</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-4-3-存储结构" tabindex="-1"><a class="header-anchor" href="#_2-4-3-存储结构" aria-hidden="true">#</a> 2.4.3 存储结构</h2>
<p><code v-pre>顺序存储</code>和<code v-pre>链式存储</code></p>
<h2 id="_2-4-4-队列分类" tabindex="-1"><a class="header-anchor" href="#_2-4-4-队列分类" aria-hidden="true">#</a> 2.4.4 队列分类</h2>
<p>队列的顺序存储：顺序队列</p>
<p>队列的链式存储：链式队列</p>
</div></template>
